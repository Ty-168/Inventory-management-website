...
import { Signupimage } from "@/components/components-signup/signupimage";
  ...
  return (
    <div className="flex flex-row justify-start items-center w-full h-full md:h-screen">
        <div className="relative w-[60%] hidden md:block">
          <Link href="/landing" className="flex flex-row justify-center items-center absolute left-5 py-5">
